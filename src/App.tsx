	...
	return (
		<>
			...
			<div className="flex flex-col items-center h-1">
				...
				<iframe className="absolute top-72 left-0 right-0 m-auto rounded-md" src="https://open.spotify.com/embed/playlist/6E6n0pbdcfj4vlZQzqzwEK?utm_source=generator" width="80%" height="500" frameBorder="0" allowFullScreen allow="encrypted-media"></iframe>
