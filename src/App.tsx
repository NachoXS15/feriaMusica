  ...
  return (
    <>
      <div className='w-full min-h-full bg-black relative'>
        <div className="w-full h-full pb-40 bg-cover bg-center"
          style={{ backgroundImage: `url(/assets/texture.png)` }}
        >
          <div className="w-full flex justify-between absolute overflow-hidden">
          ...
          <div className="w-full flex justify-between absolute bottom-0 pb-20 overflow-hidden">
          ...
          <div className="w-4/5 mt-[450px] flex justify-between m-auto relative">
