	...
	return (
		<>
			...
			<div className="flex flex-col items-center h-1">
				...
				<iframe className="absolute top-72 left-0 right-0 m-auto rounded" src="https://open.spotify.com/embed/playlist/1YydryIBCWvudofag4I13b?utm_source=generator&theme=0" width="80%" height={500} allowFullScreen allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
